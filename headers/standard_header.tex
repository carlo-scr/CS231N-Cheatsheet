% document setup
\usepackage[margin=7mm,landscape]{geometry} % margin = .. total={280mm,190 mm} % in geometry for defined size/ratio
...
%\usepackage{blindtext} % inserts lorem ipsum like text (not installed)
